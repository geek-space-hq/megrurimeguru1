...
namespace Games.megrurimeguru1.CreateWorld
{
    ...
    public interface IGetNoise
    {
        ...
        double OctavesNoise(List<NoisePram> noisePram, double x, double y, double z = 0);
    ...
    /// ノイズ生成クラス
    /// </summary>
    public class GetNoise : IGetNoise
    {
        ...
        private double CreateNoise(double x, double y, double z = 0)
        {
            //与えられたxyzから格子点を求める
            //xyzを囲む整数座標の正方形
